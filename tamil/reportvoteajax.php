...
<html>
  <head>
    ...
    <script>
      ...
      function voteUp(complaintId, username) {
        $.ajax({
          type: "GET",
          url: "voteajax.php?id=" + complaintId + "&user=" + username + "&vote=up",
          cache: true,
          success: function (html) {
            <?php
              if ($_SESSION["voteerror"] == 1) {
                ...
                echo "window.alert('Upvoted successfully');";
              }
            ?>
          }
        });
      ...
      function voteDown(complaintId, username) {
        $.ajax({
          type: "GET",
          url: "voteajax.php?id=" + complaintId + "&user=" + username + "&vote=down",
          cache: true,
          success: function (html) {
            <?php
              if ($_SESSION["voteerror"] == -1) {
                ...
                echo "window.alert('downvoted successfully');";
              }
            ?>
          }
        });
